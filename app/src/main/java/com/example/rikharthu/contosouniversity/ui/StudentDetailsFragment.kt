package com.example.rikharthu.contosouniversity.ui
...
//        return inflater!!.inflate(R.layout.fragment_student_details, container, false)
        return UI {
            verticalLayout {
                ...
                for (i in 1..10) {
                    button("Say Hello $i") {
                        onClick { ctx.toast("Hello, ${name.text}$i!") }
                    }
                }
            }
        }.view
...
//        }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): StudentDetailsFragment {
