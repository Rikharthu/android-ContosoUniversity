...
class DbSeeder(private val db: ContosoDatabase) {
    ...
    fun seedDatabase() {
        ...
        // Departments
        val departmentsDao = db.departmentDao()
        ...
        // Course Assignments
        val courseAssignmentDao = db.courseAssignmentDao()
        ...
        // Enrollments
        val enrollmentDao = db.enrollmentDao()
